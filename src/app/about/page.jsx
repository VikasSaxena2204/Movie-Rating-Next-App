...
export default function About() {
  return (
    <div className='max-w-6xl mx-auto p-3 space-y-4'>
      ...
      <h2 className='text-2xl font-medium text-amber-600 text-center bg-slate-800'>
        Code By{' '}
        <Link href='https://github.com/VikasSaxena2204' target='_blank' rel='noopener noreferrer' className='underline'>
          VikasSaxena2204
        </Link>
      </h2>
    </div>
